...
async function foreign_asset_check() {
  ...
  const address =
    "0x246044e82dcb430908830f90e8c668b02544004d66eab58af5124b953ef57d37";
  const asset = {
    parents: 2,
    interior: {
      X4: [
  ...
  const bal = await api.query.foreignAssets.account(
    asset,
    "0xfe65a1a2841217761050ef9c15109755d710cee689f764e8270c3e11292bcd10",
  );
  console.log(`bal foreign:`, bal.toHuman());
  console.log(`bal: `, bal.toHuman().balance);
  const x = await get_foreign_simple(
    api,
    "usdt",
    "0xfe65a1a2841217761050ef9c15109755d710cee689f764e8270c3e11292bcd10",
  );
