 ...
 * @returns {string}
 */
export function generate_commitment(secret) {
...
/**
 * @param {Uint8Array} parambytes
 * @returns {string}
 */
export function pdata(parambytes) {
    const ptr0 = passArray8ToWasm0(parambytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.pdata(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getCachedStringFromWasm0(ret[0], ret[1]);
...
/**
 * @param {any} parambytes
 * @returns {string}
 */
export function test_proofo(parambytes) {
    const ret = wasm.test_proofo(parambytes);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {string}
 */
export function generate_proof_data(secret, parambytes) {
    const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.generate_proof_data(ptr0, len0, parambytes);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getCachedStringFromWasm0(ret[0], ret[1]);
...
function __wbg_init_memory(imports, memory) {
    imports.wbg.memory = memory || new WebAssembly.Memory({initial:21,maximum:65536,shared:true});
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('generate_zk_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
